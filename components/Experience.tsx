  ...
  const data = [
    {
      title: "Apr 2026",
      content: (
        <div className="flex flex-col gap-6 text-neutral-600 dark:text-neutral-400 text-sm md:text-base font-normal">
          
          <div>
            <p className="font-semibold text-neutral-800 dark:text-neutral-200 mb-1 tracking-wider text-xs uppercase">Event</p>
            <p>Hack-O-Mania 2.0</p>
            <p className="text-sm text-neutral-700 dark:text-neutral-300 font-medium mt-1.5">30 Hours &middot; Offline &middot; SVKM’s NMIMS, Chandigarh &middot; 20 Teams</p>
          </div>

          <div>
            <p className="font-semibold text-neutral-800 dark:text-neutral-200 mb-1 tracking-wider text-xs uppercase">Role</p>
            <p>Team Lead &middot; Backend Development &middot; Database</p>
          </div>

          <div>
            <p className="font-semibold text-neutral-800 dark:text-neutral-200 mb-1 tracking-wider text-xs uppercase">Result</p>
            <p>Qualified for the Offline Round</p>
            <div className="mt-2 pl-4 border-l-2 border-neutral-300 dark:border-neutral-700 text-neutral-600 dark:text-neutral-500">
          ...
          <div>
            <p className="font-semibold text-neutral-800 dark:text-neutral-200 mb-1 tracking-wider text-xs uppercase">Takeaway</p>
            <p>Learned to develop and present a complete technical solution under hackathon conditions.</p>
          </div>

          <div>
            <p className="font-semibold text-neutral-800 dark:text-neutral-200 mb-1 tracking-wider text-xs uppercase">Project</p>
            <button 
              onClick={() => window.dispatchEvent(new CustomEvent("openProjectModal", { detail: { slug: "lumiere" } }))}
              className="text-neutral-900 dark:text-white hover:text-neutral-600 dark:hover:text-neutral-300 transition-colors underline underline-offset-4 bg-transparent border-none p-0 cursor-pointer text-left"
            >
              Lumiere
            </button>
          </div>
      ...
      content: (
        <div className="flex flex-col gap-6 text-neutral-600 dark:text-neutral-400 text-sm md:text-base font-normal">
          ...
          <div>
            <p className="font-semibold text-neutral-800 dark:text-neutral-200 mb-1 tracking-wider text-xs uppercase">Event</p>
            <p>Confluence 2.0</p>
            <p className="text-sm text-neutral-700 dark:text-neutral-300 font-medium mt-1.5">81 Hours &middot; Online &middot; SRM Institute of Science and Technology &middot; 500+ Teams &middot; 2,000+ Participants</p>
          </div>
          ...
          <div>
            <p className="font-semibold text-neutral-800 dark:text-neutral-200 mb-1 tracking-wider text-xs uppercase">Result</p>
            <p>Rank 67</p>
            <div className="mt-2 pl-4 border-l-2 border-neutral-300 dark:border-neutral-700 text-neutral-600 dark:text-neutral-500 space-y-1">
      ...
      content: (
        <div className="flex flex-col gap-6 text-neutral-600 dark:text-neutral-400 text-sm md:text-base font-normal">
          ...
          <div>
            <p className="font-semibold text-neutral-800 dark:text-neutral-200 mb-1 tracking-wider text-xs uppercase">Event</p>
            <p>StoxraHack 2026</p>
            <p className="text-sm text-neutral-700 dark:text-neutral-300 font-medium mt-1.5">48 Hours &middot; Online &middot; Hosted by Stoxra &middot; 800+ Teams &middot; 3,500+ Participants</p>
          </div>
      ...
      content: (
        <div className="flex flex-col gap-6 text-neutral-600 dark:text-neutral-400 text-sm md:text-base font-normal">
          ...
          <div>
            ...
            <p className="text-sm text-neutral-700 dark:text-neutral-300 font-medium mt-1.5">20 Teams &middot; NMIMS Chandigarh</p>
          </div>
          ...
          <div>
            <p className="font-semibold text-neutral-800 dark:text-neutral-200 mb-1 tracking-wider text-xs uppercase">Result</p>
            <p className="text-neutral-800 dark:text-neutral-200 font-medium">Winner &middot; Selected for SIH 2026</p>
            <div className="mt-2 pl-4 border-l-2 border-neutral-300 dark:border-neutral-700 text-neutral-600 dark:text-neutral-500 space-y-1">
      ...
      content: (
        <div className="flex flex-col gap-6 text-neutral-600 dark:text-neutral-400 text-sm md:text-base font-normal">
          ...
          <div>
            ...
            <p className="text-sm text-neutral-700 dark:text-neutral-300 font-medium mt-1.5">24 Hours &middot; Offline &middot; Plaksha University, Mohali &middot; 150 Teams</p>
          </div>
          ...
          <div>
            <p className="font-semibold text-neutral-800 dark:text-neutral-200 mb-1 tracking-wider text-xs uppercase">Result</p>
            <p className="flex items-center gap-2 text-neutral-800 dark:text-neutral-200 font-medium">
              Winner 
